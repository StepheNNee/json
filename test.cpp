...
static void test_parse_array() {
    ...
    EXPECT_EQ_DOUBLE(123.0, v->get_array()[3]->get_number());
    EXPECT_EQ_STRING("abc", v->get_array()[4]->get_string().c_str(), v->get_array()[4]->get_string().size());
    Value::delete_value(v);
...
static void test_parse_object() {
    ...
    EXPECT_EQ_DOUBLE(123.0, v->get_object()["i"]->get_number());
    EXPECT_EQ_INT(VALUE_STRING, v->get_object()["s"]->get_type());
    EXPECT_EQ_STRING("abc", v->get_object()["s"]->get_string().c_str(), v->get_object()["s"]->get_string().size());
